...
.. [1] The use of the name ``workflow_defs.py`` is not a requirement
       Rather, this is a convenient convention that we adopt throughout this documentation.
       Note that some early versions of the SDK did enforce this name, but this restriction has since been lifted.
