...
def _locate_callable(fn_ref_dict) -> t.Callable:
    ...
    if fn_ref_dict["type"] == "MODULE_FUNCTION_REF":
        fn_ref = ir.ModuleFunctionRef.model_validate_json(fn_ref_dict)
        return locate_fn_ref(fn_ref)

    elif fn_ref_dict["type"] == "FILE_FUNCTION_REF":
        fn_ref = ir.FileFunctionRef.model_validate_json(fn_ref_dict)
        ...
        fn_ref = ir.InlineFunctionRef.model_validate_json(fn_ref_dict)
