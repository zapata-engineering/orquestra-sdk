...
from orquestra.sdk._client._spaces._api import make_workspace_zri
...
from orquestra.sdk.schema.regex import VERSION_REGEX
...
class DriverClient:
    ...
    def create_workflow_def(
        ...
        Raises:
            orquestra.sdk._client._driver._exceptions.InvalidWorkflowDef: when an invalid
                Workflow Definition is sent to the Workflow Driver.
            orquestra.sdk._client._driver._exceptions.InvalidTokenError: when the
                authorization token is rejected by the remote cluster.
            orquestra.sdk._client._driver._exceptions.ForbiddenError: when attempting to
                access a workspace that does not belong to the user.
            orquestra.sdk._client._driver._exceptions.UnknownHTTPError: when any other
    ...
    def get_workflow_def(
        ...
        Raises:
            orquestra.sdk._client._driver._exceptions.InvalidWorkflowDefID: when the
                workflow def ID is incorrectly formatted.
            orquestra.sdk._client._driver._exceptions.WorkflowDefNotFound: when no
    ...
    def create_workflow_run(
        ...
        Raises:
            orquestra.sdk._client._driver._exceptions.InvalidWorkflowRunRequest: when an
                invalid Workflow Run request is sent to the Workflow Driver.
            orquestra.sdk._client._driver._exceptions.UnsupportedSDKVersion: when an
    ...
    def get_workflow_run(self, wf_run_id: _models.WorkflowRunID) -> WorkflowRun:
        ...
        Raises:
            orquestra.sdk._client._driver._exceptions.InvalidWorkflowRunID: when the
                wf_run_id is empty or incorrectly formatted.
            orquestra.sdk._client._driver._exceptions.WorkflowRunNotFound: when the
    ...
    def get_workflow_run_artifact(
        ...
        Raises:
            orquestra.sdk._client._driver._exceptions.InvalidWorkflowRunArtifactID: when
                the artifact_id is empty or incorrectly formatted.
            orquestra.sdk._client._driver._exceptions.WorkflowRunArtifactNotFound: when
    ...
    def get_workflow_run_result(
        ...
        Raises:
            orquestra.sdk._client._driver._exceptions.InvalidWorkflowRunResultID: when the
                result_id is empty or incorrectly formatted.
            orquestra.sdk._client._driver._exceptions.WorkflowRunResultNotFound: when the
    ...
    def get_workflow_run_logs(
        ...
        Raises:
            ...
            orquestra.sdk._client._driver._exceptions.UnknownHTTPError: when any other
                error is raised by the remote cluster.
            orquestra.sdk._client._driver._exceptions.WorkflowRunLogsNotReadable: when
    ...
    def get_task_run_logs(
        ...
        Raises:
            orquestra.sdk._client._driver._exceptions.InvalidWorkflowRunID: when the
                wf_run_id is empty or incorrectly formatted.
            orquestra.sdk._client._driver._exceptions.TaskRunLogsNotFound: when the
    ...
    def get_system_logs(self, wf_run_id: _models.WorkflowRunID) -> List[_models.SysLog]:
        ...
        Raises:
            ...
            orquestra.sdk._client._driver._exceptions.InvalidWorkflowRunID: when the
                wf_run_id is empty or incorrectly formatted.
            orquestra.sdk._client._driver._exceptions.WorkflowRunLogsNotFound: when the
