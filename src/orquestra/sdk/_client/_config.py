...
import orquestra.sdk._client.exceptions as exceptions
...
def read_config(
    ...
    Raises:
        orquestra.sdk._client.exceptions.ConfigNameNotFoundError: when no runtime
            config matching `config_name` exists.
        orquestra.sdk._client.exceptions.ConfigFileNotFoundError: when no config file exists.
    """
    if config_name in SPECIAL_CONFIG_NAME_DICT:
