...
from orquestra.sdk.schema import ir, serde
from orquestra.sdk.schema.configs import ConfigName
from orquestra.sdk.schema.logs import WorkflowLogs
from orquestra.sdk.schema.responses import WorkflowResult
from orquestra.sdk.schema.workflow_run import ProjectId, State
...
from orquestra.sdk.schema.workspaces import ProjectRef
from orquestra.sdk.schema.graphs import iter_invocations_topologically
...
class WorkflowRun:
    ...
    def by_id(
        ...
        Raises:
            orquestra.sdk._client.exceptions.RuntimeQuerySummaryError: when ``config``
                wasn't passed, and it wasn't possible to infer the runtime
                matching ``wf_run_id``.
            orquestra.sdk._client.exceptions.WorkflowRunNotFoundError: when ``config`` was
                passed, but a matching workflow run couldn't be found.
            orquestra.sdk._client.exceptions.UnauthorizedError: when ``config`` was passed,
    ...
    def project(self):
        ...
        Raises:
            orquestra.sdk._client.exceptions.WorkspacesNotSupportedError: when runtime
    ...
    def _task_matches_api_filters(
        ...
        """Filters that can applied to orquestra.sdk._client._api._task_run.TaskRun."""
