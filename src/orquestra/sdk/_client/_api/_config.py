...
class RuntimeConfig:
    ...
    def load(
        ...
        Raises:
            orquestra.sdk._client.exceptions.ConfigFileNotFoundError: When the config file is
                of a higher version than this version of the SDK supports.
            orquestra.sdk._client.exceptions.ConfigNameNotFoundError: When the specified config
