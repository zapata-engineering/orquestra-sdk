...
from orquestra.sdk.schema.kubernetes.quantity import parse_quantity
from . import _ast
...
class TaskDef(Generic[_P, _R], wrapt.ObjectProxy):
    ...
    def __init__(
        self,
        fn: Callable[_P, _R],
        output_metadata: "orquestra.sdk._client._dsl.TaskOutputMetadata",
...
class ArtifactFormat(Enum):
    ...
    # time. See orquestra.sdk._client for details.
    #
    ...
    # This has to be accompanied by corresponding implementation in orquestra.sdk._client.
    AUTO = "AUTO"
...
class ArtifactFuture:
    ...
    def __init__(
        self,
        invocation: orquestra.sdk._client._dsl.TaskInvocation,
        output_index: Optional[int] = None,
        custom_name: Optional[str] = DEFAULT_CUSTOM_NAME,
        serialization_format: orquestra.sdk._client._dsl.ArtifactFormat = DEFAULT_SERIALIZATION_FORMAT,  # noqa: E501
    ):
    ...
    def with_invocation_meta(
        ...
        *,
        cpu: Optional[
            Union[str, "orquestra.sdk._client._dsl.Sentinel"]
        ] = Sentinel.NO_UPDATE,
        memory: Optional[
            Union[str, "orquestra.sdk._client._dsl.Sentinel"]
        ] = Sentinel.NO_UPDATE,
