    ...
    *,
    ...
    Raises:
        orquestra.sdk._client.exceptions.ConfigNameNotFoundError: when no matching config was
            found.
        orquestra.sdk._client.exceptions.NotFoundError: when no secret with the given name
            was found.
        orquestra.sdk._client.exceptions.UnauthorizedError: when the authorization with the
            remote vault failed.
    ...
    """
    if exec_ctx.global_context == exec_ctx.ExecContext.WORKFLOW_BUILD:
        return t.cast(
            str,
...
def delete(
    ...
    *,
    ...
    Raises:
        orquestra.sdk._client.exceptions.ConfigNameNotFoundError: when no matching config was
            found.
        orquestra.sdk._client.exceptions.NotFoundError: when the secret ``name`` couldn't be
            found.
        orquestra.sdk._client.exceptions.UnauthorizedError: when the authorization with the
            remote vault failed.
    """
