...
from orquestra.sdk.schema.logs import LogReader
...
class RayRuntime:
    ...
    def get_workflow_run_status(self, workflow_run_id: WorkflowRunId) -> WorkflowRun:
        ...
        Raises:
            orquestra.sdk._client.exceptions.WorkflowRunNotFoundError: if no run with
    ...
    def get_output(
        ...
        Raises:
            orquestra.sdk._client.exceptions.WorkflowRunNotFoundError: if no run with
                ``workflow_run_id`` was found.
            orquestra.sdk._client.exceptions.exceptions.NotFoundError: if requested task
